...
loggingIngestionKey = os.environ.get('WORKSPACE_ID')

log = logging.getLogger('logdna')
log.setLevel(logging.INFO)

options = {
  'hostname': 'ibm-code-engine',
  'env': 'cd-project-rolling-iaas',
  'level': 'Info',
  'index_meta': True,
...
while True:
    ...
    if (jobStatus == 'job_in_progress' or jobStatus == 'job_pending'):
        ...
        logging.info("Workspace update in progress. Generated by workspace activity ID: " + updateActivityId + ".")
        time.sleep(20)
    else:
        print("Workspace update complete. Starting Workspace plan.")
        logging.info("Workspace update complete. Starting Workspace plan.")
        break
